...
class TokenWithUser {
    ...
    factory TokenWithUser.fromRawJson(String str) => TokenWithUser.fromJson(json.decode(str));
...
class User {
    ...
    Map<String, dynamic> toJson() => {
        ...
        "age": age,
        "state": state,
        "confirmation_date": "${confirmationDate.year.toString().padLeft(4, '0')}-${confirmationDate.month.toString().padLeft(2, '0')}-${confirmationDate.day.toString().padLeft(2, '0')}",
        "dose_one_date": "${doseOneDate.year.toString().padLeft(4, '0')}-${doseOneDate.month.toString().padLeft(2, '0')}-${doseOneDate.day.toString().padLeft(2, '0')}",
        "dose_one_time": doseOneTime,
        "dose_one_manufacturer": doseOneManufacturer,
        "dose_one_batch": doseOneBatch,
        "dose_two_date": "${doseTwoDate.year.toString().padLeft(4, '0')}-${doseTwoDate.month.toString().padLeft(2, '0')}-${doseTwoDate.day.toString().padLeft(2, '0')}",
